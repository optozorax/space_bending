...
export class MeshHandle {
     ...
     */
    get_triangle_buffer() {
        const ret = wasm.meshhandle_get_triangle_buffer(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get_uv_buffer() {
        const ret = wasm.meshhandle_get_uv_buffer(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get_triangle_count() {
        const ret = wasm.meshhandle_get_triangle_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {string} name
